...
NumFreqBins = 256  #128 #
NumFFTPoints = 2048
HopLength = int(NumFFTPoints/4) #2)
...
Basepath = os.getcwd() + '/' 
spectrum_path = Basepath + 'system_outputs/task1b_256_862/spectrums/'
if not os.path.exists(spectrum_path):
    os.makedirs(spectrum_path)
    
feature_path = Basepath + 'system_outputs/task1b_256_862/features/'
if not os.path.exists(feature_path):
    os.makedirs(feature_path)
    
normalization_path = Basepath + 'system_outputs/task1b_256_862/normalizations/'
if not os.path.exists(normalization_path):
    os.makedirs(normalization_path)
    
model_path = Basepath + 'system_outputs/task1b_256_862/learners/'
if not os.path.exists(model_path):
    os.makedirs(model_path)

result_path = Basepath + 'system_outputs/task1b_256_862/recognizers/'
if not os.path.exists(result_path):
    os.makedirs(result_path)
    
log_path = Basepath + 'log_256/'
...
print('Spectrum Correction')
print('========================================')
print('-----Calculated spectrum correction coefficients')  
...
#        #feature_sqrt_var = np.mean((np.abs(features-feature_mean))**2, axis=1).reshape(-1,1)
    ...
    print('feature_mean_finalize shape {}'.format(feature_mean_finalize.shape))
    #print('feature_mean_finalize {}'.format(feature_mean_finalize))
    print('feature_std_finalize shape {}'.format(feature_std_finalize.shape))
    #print('feature_std_finalize {}'.format(feature_std_finalize))
...
for model_name_ in model_names: 
    ...
    print('__________all______{}______'.format(model_name_))
...
#    
    ...
    print('__________A______{}______'.format(model_name_))
...
#    
    ...
    print('__________B______{}______'.format(model_name_))
...
#    print("mean per-class precision: ",mean_precision)
    ...
    print('__________C______{}______'.format(model_name_))
...
#    
    ...
    print('__________BC______{}______'.format(model_name_))
